  ...
  return (
    <div className="relative max-w-5xl mx-auto text-center px-4 py-8 overflow-hidden">
      ...
      <div className="mb-12 relative z-10">
        <div className="inline-flex items-center gap-2.5 bg-gradient-to-r from-indigo-700 via-purple-600 to-pink-600 dark:from-indigo-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent mb-4">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto relative z-10">
        <div className="p-6 bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-300">
        ...
        <div className="p-6 sm:col-span-2 lg:col-span-1 bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-300">
